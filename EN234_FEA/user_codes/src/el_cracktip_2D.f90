...
!==========================SUBROUTINE el_cracktip_2d ==============================
subroutine el_cracktip_2d(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    ...
    return
end subroutine el_cracktip_2d


!==========================SUBROUTINE el_cracktip_2d_dynamic ==============================
subroutine el_cracktip_2d_dynamic(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    n_properties, element_properties,element_coords, length_coord_array, &                               ! Input variables
    dof_increment, dof_total, length_dof_array,  &                                                       ! Input variables
    n_state_variables, initial_state_variables, &                                                        ! Input variables
    ...
    return
end subroutine el_cracktip_2d_dynamic


!==========================SUBROUTINE fieldvars_cracktip_2d ==============================
subroutine fieldvars_cracktip_2d(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    n_properties, element_properties,element_coords,length_coord_array, &                                ! Input variables
    dof_increment, dof_total, length_dof_array,  &                                                      ! Input variables
    ...
    return
end subroutine fieldvars_cracktip_2d
