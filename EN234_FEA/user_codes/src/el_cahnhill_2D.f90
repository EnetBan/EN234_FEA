...
!==========================SUBROUTINE fieldvars_cahnhill_2d ==============================
subroutine fieldvars_cahnhill_2d(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    n_properties, element_properties,element_coords,length_coord_array, &                                ! Input variables
    dof_increment, dof_total, length_dof_array,  &                                                      ! Input variables
    ...
    return
end subroutine fieldvars_cahnhill_2d
